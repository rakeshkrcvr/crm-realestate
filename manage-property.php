...
<?php 
      ...
      if(isset($_POST['submit'])){
        ...
        if ($_FILES['property_image']['name'])
          {
              move_uploaded_file($_FILES['property_image']['tmp_name'], "uploads/" . $_FILES['property_image']['name']);
              $property_image = "uploads/" . $_FILES['property_image']['name'];
          }

          // insert qurey in datatable code

          $query =  "INSERT INTO property_list (property_image,property_name,property_location,property_type,property_rent_buy,property_discription,btn_text,btn_link,property_area,property_beds,property_baths,property_parking) 
                                        VALUES ('$property_image','$property_name','$property_location','$property_type','$property_rent_buy','$property_discription','$btn_text','$btn_link','$property_area','$property_beds','$property_baths','$property_parking')";
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form method="POST" action="manage-property.php" enctype="multipart/form-data">
                       <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Property Image</label>
                          <div class="col-sm-10">
                            <input type="file" class="form-control" name="property_image" id="" placeholder="Property Image" />
                          </div>
                        </div>
